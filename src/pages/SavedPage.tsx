  ...
  return (
    <div className="bg-[#f5f5f5] min-h-screen">
      <div className="container max-w-7xl mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-2xl font-black text-[#111111] mb-1">Сохранённое</h1>
        ...
        {saved.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-32 text-center">
            <div className="w-20 h-20 rounded-3xl bg-white border border-gray-100 flex items-center justify-center mb-6 shadow-sm">
              <Icon name="Heart" size={32} className="text-gray-300" />
            </div>
            <h2 className="text-xl font-bold mb-2 text-[#111111]">Здесь пока пусто</h2>
